...
import 'package:web_dashboard_flutter/constants/style.dart';
            ...
            title: Row(
              children: [
                Visibility(child:CustomText(text:'Dash',
                  color:lightGrey,size: 20,weight: FontWeight.bold,
                )),
                ...
                Container(
                  width:1,height:22,color: lightGrey,
                ),
                SizedBox(width: 24,),
